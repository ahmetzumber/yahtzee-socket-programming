...
public class DiceUtility {
    ...
    public static int CALCULATE(Dice dices[], Scores score_type) {
        ...
        switch (score_type) {
            case ONES:
                score = calculateOnes(dices);
                break;
            case TWOS:
                score = calculateTwos(dices);
                break;
            case THREES:
                score = calculateThrees(dices);
                break;
            case FOURS:
                score = calculateFours(dices);
                break;
            case FIVES:
                score = calculateFives(dices);
                break;
            case SIXES:
                score = calculateSixes(dices);
                break;
            case THREEKIND:
